...
- [[concepts/ux-research/ux-metrics|UX Metrics]] — umbrella: performance (task success, time, errors) vs. attitude.
- [[concepts/ux-research/self-reported-ux-metrics|Self-Reported UX Metrics]] — SUS, SEQ, satisfaction scales.
- [[concepts/ux-research/heart-framework|HEART Framework]] — Happiness, Engagement, Adoption, Retention, Task success at product scale.
