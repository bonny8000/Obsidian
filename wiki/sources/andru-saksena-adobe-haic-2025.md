...
status: draft
created: 2026-05-27
tags: [source, paper, human-ai-collaboration]
sources: []
updated: 2026-06-12
ingest_level: deep
coverage: partial
...
# Adobe HAIC Framework (Andru & Saksena, 2025)

> [!warning] Rebuilt stub
> Original deep-ingest page lost in 2026-05/06 corruption ([[logs/2026-06-10-corruption-recovery|recovery log]]). Citation restored; claims need re-ingest from the original work.

## Citation

Andru & Saksena (2025). Adobe Human-AI Collaboration (HAIC) framework — exact citation lost in corruption; recover via [[concepts/ux-research/haic-modalities-taxonomy|HAIC Modalities Taxonomy]] backlinks.

## Summary

(To restore via re-ingest.)
...
- Connect it with [[concepts/ux-research/haic-modalities-taxonomy]] before turning it into a project recommendation.
