...
status: draft
created: 2026-05-27
tags: [source, paper, vr, spatial-ai]
sources: []
updated: 2026-06-12
ingest_level: deep
coverage: partial
...
# VR Usability (Gerhard & Norton, 2022)
...
Gerhard, D. & Norton, P. (2022). VR usability / immersive design source — exact citation lost in corruption; recover from change-log context (Spatial AI cluster, immersion/presence, sickness mitigation).
