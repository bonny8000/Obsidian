...
> [!abstract] Welcome
> This vault is an AI-maintained knowledge base. It uses a **Research-First** architecture where raw evidence (`raw/`) is synthesized into a durable concept graph (`wiki/`).
...
## 🧪 Brainstorming Lab
> [!tip] Spark New Ideas
> - **Cross-Domain Inspiration:** [[maps/spatial-ai-and-smart-city-robotics|Robotics]] ↔ [[maps/ai-ux-research-methods|UX Research]]
> - **Open Questions:** [Browse all unanswered questions](wiki/queries/)
> - **Artifact Drafting:** Use templates to turn concepts into [[_templates/project-template|Project Plans]] or [[_templates/decision-record|Decision Records]].
...
> - [[maps/ai-hardware-and-physical-ai|AI Hardware and Physical AI]]
> - [[maps/egocentric-robot-learning|Egocentric Robot Learning]]
...
### 📐 UX Metrics & Foundational Methods
> [!info] Foundations: [[concepts/ux-research/five-planes-of-ux|Five Planes]], [[concepts/ux-research/heart-framework|HEART Framework]], [[concepts/ux-research/goal-directed-design|Goal-Directed Design]]
- [[concepts/ux-research/five-planes-of-ux|Five Planes of UX]]
- [[concepts/ux-research/goal-directed-design|Goal-Directed Design]]
