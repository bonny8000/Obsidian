...
## Evidence
- [[concepts/product-management/ai-product-onboardingAI Product Onboarding]] ??"A feature like `/power-up` is positioned as a way to surface core practices inside the product. Onboarding should guide users to reliable paths without turning into visible documentation overload."
...
- [[concepts/infrastructure-dev/llm-wikiLLM Wiki]] ??"The schema layer tells the agent how to structure pages and workflows." The index can double as a human-readable schema summary.
