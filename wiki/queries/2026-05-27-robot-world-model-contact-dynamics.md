...
## Evidence
- [[concepts/robotics-spatial/robot-world-modelRobot World Model]] ??"World models can reduce reliance on real-world trial and error. Contact-rich robotics makes accurate planning difficult. Robot-data post-training is still needed to adapt the world model to target robot settings."
...
- [[concepts/infrastructure-dev/model-based-planningModel-Based Planning]] ??"Contact-rich robotics makes accurate planning difficult. Real-time speed and consistency matter for live use."
- [[concepts/robotics-spatial/dexterous-manipulationDexterous Manipulation]] ??"Large-scale egocentric human video is being explored as a motor prior for dexterous robot policies." A motor prior is not the same as contact dynamics fidelity.
