...
## Evidence
- [[concepts/ai-agents/mcp-integrationMCP Integration]] ??"Integration quality depends on structured resources and clear permission boundaries. MCP-connected planning data should remain reviewable and source-grounded."
- [[concepts/ai-agents/planning-to-code-workflowPlanning-to-Code Workflow]] ??"Planning artifacts can become inputs to coding agents. The handoff works best when artifacts are structured, current, and source-grounded."
- [[concepts/ai-agents/prd-generationPRD Generation]] ??"PRDs become more useful when linked to specs, flows, wireframes, and implementation tasks." An MCP server should surface these links.
