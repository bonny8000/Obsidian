...
- [[concepts/robotics-spatial/robot-imitation-learning|Robot Imitation Learning]] ??"Demonstration scale and diversity are central bottlenecks. Human data can complement robot data when aligned carefully."
- [[concepts/robotics-spatial/egocentric-human-data|Egocentric Human Data]] ??"Human egocentric data can cover diverse objects, environments, and everyday tasks."
- [[concepts/robotics-spatial/embodiment-gap|Embodiment Gap]] ??"Methods include hardware adaptation, visual inpainting, domain adaptation, latent-space alignment, and diverse pretraining." When these methods work, human data becomes viable; when they fail, robot data is still needed.
- [[concepts/robotics-spatial/human-to-robot-transfer|Human-to-Robot Transfer]] ??"Transfer quality depends on aligning human data with robot learning objectives."
