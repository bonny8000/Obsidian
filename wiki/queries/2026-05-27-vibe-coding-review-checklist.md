...
## Evidence
- [[concepts/ai-agents/vibe-codingVibe Coding]] ??"The workflow requires tests, diffs, version control, and review because generated code can still be wrong. Vibe coding is strongest when paired with project context and clear coding standards."
- [[concepts/ai-agents/claude-codeClaude Code]] ??"The CLI is framed as the earliest and most powerful product surface for coding tasks." CLI diffs and version control are the operational tools for this checklist.
- [[concepts/infrastructure-dev/design-system-implementationDesign System Implementation]] ??"Design-system implementation must verify rendered output, not only code-level configuration." Item 3 comes from this.
