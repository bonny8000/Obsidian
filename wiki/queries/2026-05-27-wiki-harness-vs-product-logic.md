...
## Evidence
- [[concepts/ai-agents/model-harnessModel Harness]] ??"Harness features can compensate for current model weaknesses. New model launches should trigger a review of system prompts and product crutches. Some scaffolding remains useful for user visibility even if the model no longer strictly needs it."
...
- [[concepts/infrastructure-dev/llm-wikiLLM Wiki]] ??"The raw source layer should remain immutable." This is a product-logic rule, not a model-capability workaround.
