...
## Evidence
- [[concepts/product-management/shipping-velocityShipping Velocity]] ??"AI product timelines can shrink from months to weeks or days. Velocity should be paired with user feedback loops and quality checks, not treated as output volume alone."
- [[concepts/ai-agents/agentic-work-automationAgentic Work Automation]] ??"The goal is to push workflows toward trustable, repeatable execution with clear verification. A prototype that is never used daily creates little leverage."
- [[concepts/product-management/research-previewResearch Preview]] ??"Research Preview can lower internal friction by reducing the perceived cost of shipping. It works best when paired with fast iteration and clear communication." Treating wiki automation experiments as personal research previews is the right framing.
