...
## Evidence
- [[concepts/ai-agents/autonomous-ai-agentAutonomous AI Agent]] ??"Autonomy requires guardrails, approvals, and clear operating instructions." Scoped write access is the minimal-footprint implementation of this.
...
- [[concepts/ai-agents/agent-identityAgent Identity]] ??"Long-running design or research agents need scoped access rather than broad ambient access."
